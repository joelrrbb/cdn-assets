...
layui.define(function (exports) {
    ...
    !function (global, factory) {
        ...
        var initArgs = {
            elem: "body",           // Default container is body, can be class or id
            msg: "",                // Message content
            closable: true,         // Whether to show close button
            duration: 3000,         // Default close after 3 seconds
            position: 'topCenter',  // Display position: bottomRight, bottomLeft, topRight, topLeft, topCenter, bottomCenter, vcenter
            shadow: false           // Whether to show overlay
        };
        ...
        var notify = {
            ...
            loading: function loading() {
                ...
                el.value = function (n) { // Percentage value
                    if (typeof n === 'number') {
            ...
            close: function (element) {
                if (element && element.nodeType === Node.ELEMENT_NODE) {
                    ...
                    console.warn('The passed parameter is not a valid DOM element');
                }
            },
        ...
        function initConfig(obj, type) {
            ...
            if (type == "alert" || type == "confirm") {
                _args.position = "vcenter"; // Default to vertically centered
            }
        ...
        function createMsgEl(args) {
            ...
            if (type === "loading") {
                ...
                //closable = false; //No close button is displayed during loading
            }

            var positionB=['bottomLeft','bottomCenter','bottomRight'];//Pop-up at the bottom of the page
            var el,an;
            if(positionB.indexOf(position)!==-1){
                ...
                el = c({
                    ...
                    _click: function _click() {
                        if (closable) {
                            closeFlag = true; //Click the close button icon
                            flag = false; //Normal shutdown flag
            ...
            if(type==="confirm"){
                ...
                var textNode=document.createTextNode("Cancelar");
        ...
        function getMsgRight(closable,type) {
            if (closable) {
                if(type==="alert" || type==="confirm"){
                    return '<button type="button" class="btnOk">Aceptar</button>'
                }else{
        ...
        var flag = true; //Normal shutdown flag
        var closeFlag = false;//Click the close button icon
